...
class Rectangle: Figure {
    ...
    func description() {
        print("Rectangle area is: \(squareOfFigure()), and a perimeter of figure is: \(perimeterOfFigure())")
    }
}

let myRectangle = Rectangle(height: 4, width: 2, radius: 0 , square: 0 , perimeter: 0)
