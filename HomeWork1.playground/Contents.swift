...
print("My age is \(myAge) years. In 10 years, I will be \(myAgeInTenYears) years old. From the moment of my birth day have passed \(Int(daysPassed)) days.")
...
var triangleArea : Double = (1/2) * AC * CB

// Perimeter = 1st side + 2nd side + 3d side

var trianglePerimeter : Double = AC + CB + AB
